  ...
  def compose(self) -> ComposeResult:
    ...
    with Vertical(id="db_query_pane"):
      ...
      with Horizontal(id="db_query_input_container"):
        ...
        yield ActionButton(OPEN_EXTERNAL, action=self.on_popout_query, id="btn_popout_query", tooltip="Open Query Editor", classes="action-btn icon-btn top-pad")
        yield RunButton(action=self.on_run_query, id="btn_run_query", tooltip="Run Query", classes="action-btn icon-btn top-pad")
